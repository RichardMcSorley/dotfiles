...
return {
  ...
  keys = {
    ...
    },
    {
      key = 'f',
      mods = 'CTRL|SHIFT',
      action = wezterm.action.SendString ' sf',
    },
    {
      key = 't',
      mods = 'CTRL|SHIFT',
      action = wezterm.action.SendString ' st',
    },
    ...
    { key = '/', mods = 'SUPER', action = act.SendString '++' },
    ...
    { key = 'F', mods = 'CTRL', action = act.SendString ' sf' },
    ...
    { key = 'T', mods = 'CTRL', action = act.SendString ' st' },
    { key = 'U', mods = 'CTRL',
    ...
    { key = 'n', mods = 'SHIFT|CTRL', action = act.SpawnWindow },
    { key = 'p', mods = 'SHIFT|CTRL', action = act.PaneSelect { alphabet = '', mode = 'Activate' } },
    { key = 'p', mods = 'SUPER', action = act.SendString 'e' },
    { key = 'q', mods = 'SHIFT|CTRL', action = act.QuitApplication },
